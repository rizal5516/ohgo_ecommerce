                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="product-details text-left">
                                    ...
                                    <div class="quantity">
                                        <router-link to="/shopping-cart" class="primary-btn pd-cart">Add To
                                            Cart</router-link>
                                    </div>
                                </div>
                            </div>
...
<script>
// @ is an alias to /src
import HeaderEcomVue from '@/components/HeaderEcom.vue';
